...
setwd(input_dir)
load(file='./estimated_sigma_sample_Type_I_1D_GFL_middle_stop_criteria_K_grid_200_level_2_0_sim_times_1000_random_seed_2021.RData')
...
png(paste0(plot_output_dir,'Figure_13_b.png'),
