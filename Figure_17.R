...
# solve for solution
GFL_sol <- genlasso::fusedlasso(y=log_rate,D=US_Dmat,maxsteps=(K+1))
gfl_sol_staes <- data.frame(
  log_rate = teen_birth$log_rate,
  State = teen_birth$State,
  sol_step_K = GFL_sol$beta[,(K+1)]
)
...
png(paste0(plot_output_dir,'Figure_17b.png'),
...
list_results <- list(p_val_c1_c2, p_val_c1_c3, 
  p_val_c1_c4, p_val_c1_c5, 
  p_val_c2_c3,p_val_c2_c4, 
  p_val_c2_c5, p_val_c3_c4, 
  p_val_c3_c5, p_val_c4_c5)
...
png(paste0(plot_output_dir,'Figure_17d.png'),
